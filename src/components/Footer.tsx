...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      ref={ref}
      className="px-6 lg:px-8 py-20 bg-white border-t border-gray-200"
    >
        ...
        >
          ...
          <div className="text-center space-y-6">
            ...
            <p className="text-gray-600 text-lg max-w-xl mx-auto">
              ...
              If you'd like to discuss a role or just want to connect, feel free to reach out!
            </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xl font-bold text-gray-900">Kushal Sai</span>
          ...
          <div className="text-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Kushal Sai. Built with Next.js & Tailwind CSS.
            </p>
          </div>
        </motion.div>
      </div>
